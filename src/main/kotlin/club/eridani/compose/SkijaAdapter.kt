...
internal fun makeGLRenderTarget(width: Int, height: Int, sampleCnt: Int, stencilBits: Int, fbId: Int, fbFormat: Int) =
    BackendRenderTarget.makeGL(width, height, sampleCnt, stencilBits, fbId, fbFormat)
